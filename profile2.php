            ...
            <div class="card bg-secondary shadow">
              ...
              if(mysqli_num_rows($result)>0){
                  ...
                  while($row=mysqli_fetch_array($result)){
                     // echo "<div class='col-8' style='border-left-style: solid;margin-right: auto;margin-left: auto;width:650px;height:200px;margin-bottom:10px'>";
                     echo "<div class='col-8' style='border-left-style: solid;'>";
